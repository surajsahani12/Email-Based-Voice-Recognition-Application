...
class Register:
    ...
    def __init__(self, root):
        ...
        self.entry_fname = StringVar()
        # talk("Please Speak your Last name")
        self.entry_lname = StringVar()
        ...
        self.entry_conf_pass = StringVar()
        ...
        f_name.place(x=230, y=100, width=330)
        l_name.place(x=230, y=150, width=330)
        e_value.place(x=230, y=200, width=330)
        pass_value.place(x=230, y=250, width=330)
        conf_pass_value.place(x=230, y=300, width=330)
